...
export function flowAsync<Args extends readonly any[], R1, R2>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>
): AwaitableFunction<Args, R2>;
export function flowAsync<Args extends readonly any[], R1, R2, R3>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>
): AwaitableFunction<Args, R3>;
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>
): AwaitableFunction<Args, R4>;
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
...
export function flowAsync<Args extends readonly any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18>(
  f1: AwaitableFunction<Args, R1>,
  f2: AwaitableFunction<[Awaited<R1>], R2>,
  f3: AwaitableFunction<[Awaited<R2>], R3>,
  f4: AwaitableFunction<[Awaited<R3>], R4>,
